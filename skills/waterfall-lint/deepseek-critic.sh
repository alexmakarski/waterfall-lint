#!/usr/bin/env bash
# DeepSeek adversarial critic invocation for the waterfall-lint skill (forked from critic-gauntlet).
#
# Usage: deepseek-critic.sh <work-folder> <round-number> [--mode qa] (default: qa)
# Example: deepseek-critic.sh /path/to/reviews/wfl-2026-08-14 1 --mode qa
#
